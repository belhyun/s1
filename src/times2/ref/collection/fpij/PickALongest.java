...
public class PickALongest {
    public static void main(final String[] args) {
        ...
        //다음과 같이 정의도 가능하다
        final String aLongName2 =
                friends.stream().collect(reducing("", identity(), maxBy(comparingInt(String::length))));

        aLongName.ifPresent(name ->
                System.out.println(String.format("A longest name: %s", name)));
        System.out.println(String.format("A longest name2: %s", aLongName2));
